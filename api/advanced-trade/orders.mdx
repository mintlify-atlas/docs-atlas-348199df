...
<ParamField body="attached_order_configuration" type="OrderConfiguration">
...
<ParamField query="time_in_forces" type="string[]">
...
<ParamField query="order_placement_source" type="string">
...
<ParamField query="asset_filters" type="string[]">
...
<ParamField query="retail_portfolio_id" type="string">
...
<ParamField body="retail_portfolio_id" type="string">
