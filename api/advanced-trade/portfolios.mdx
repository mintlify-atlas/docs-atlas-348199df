...
<ParamField query="portfolio_type" type="string">
  Filter by type: `"DEFAULT"`, `"CONSUMER"`, `"INTX"`, or `"UNDEFINED"`.
</ParamField>
...
The following endpoints interact with the Coinbase International Exchange (Intx) perpetuals platform associated with a portfolio.
