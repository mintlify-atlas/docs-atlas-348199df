...
description: "Learn how to obtain and configure API credentials for each Coinbase platform: JWT-based keys for Advanced Trade and App, and passphrase keys for Exchange, International, and Prime."
---
